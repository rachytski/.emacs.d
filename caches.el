...
(defun user-cache-path (subpath)
  (expand-file-name subpath user-cache-dir))
...
(setq eshell-directory-name
      (ensure-directory user-cache-dir "eshell"))
...
(setq
 backup-by-copying t ; copy, don't symlink
...
(setq projectile-known-projects-file
      (user-cache-path "projectile-bookmarks.eld"))
